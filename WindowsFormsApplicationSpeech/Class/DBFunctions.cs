...
namespace WindowsFormsApplicationSpeech
{
    public class DBFunctions
    {
        ...
        public static SqlConnection GenerateConnection()
        {
            ...
            conObj.ConnectionString =(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\ps\Desktop\123\hackton1\WindowsFormsApplicationSpeech\DatabaseUsers.mdf;Integrated Security=True");
